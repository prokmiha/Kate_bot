...
Сума в гривнях: 
2400 грн — пакет без зворотнього зв’язку 
4250 грн — пакет зі зворотнім зв’язком від мене
...
Сума в евро: 
60€ — пакет без зворотнього зв’язку 
105€ — зі зворотнім зв’язком від мене особисто ''', parse_mode="HTML")
...
Початок кінотерапії — 23-го жовтня. 
