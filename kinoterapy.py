...
Сума в гривнях: 
3680 грн — пакет без зворотнього зв’язку 
6000 грн — пакет зі зворотнім зв’язком від мене
...
Сума в евро: 
95€ — пакет без зворотнього зв’язку 
155€ — зі зворотнім зв’язком від мене особисто ''', parse_mode="HTML")
